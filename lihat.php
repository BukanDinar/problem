...
<form action="" method="POST">
        ...
        <table border="1" width="100%">
          ...
          <tr class="form-group">
            <th>Jumlah panitia yang ikut</th>
            <th style="width: 4%; text-align: center;"> : </th>
            <td><input readonly type="text" name="panitia_jumlahk" value="<?php echo $mhs['panitia_jumlah']?>" class="form-control"></td>
            <tr class="form-group">
                <th>Bank X</th>
                <th style="width: 4%; text-align: center;"> : </th>
...
<br>
    <a class="btn btn-danger btn-block btn-lg" href="lihat-print.php" target="_blank">Print</a>
